...
// HashSize is the size of all hashes in bytes (32 bytes for both SHA256 and Poseidon with Pallas).
const HashSize = 32
...
// This abstraction allows swapping between SHA256 and Poseidon hash functions.
